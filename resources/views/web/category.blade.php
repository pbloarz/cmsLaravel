                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="price-before-discount">{{$product->actualPrice}}</span> </div>
                                            <!-- /.product-price -->
                                  ...
                                  <div class="row product-list-row">
                                      ...
                                      <div class="col col-sm-9 col-lg-9">
                                          <div class="product-info">
                                              ...
                                              <div class="product-price">
                                                  <span class="price"> {{$product->previousPrice}}</span>
                                                  <span class="price-before-discount">{{$product->actualPrice}}</span>
                                              </div>
                                              <!-- /.product-price -->
                                              ...
                                              <div class="cart clearfix animate-effect">
                                                  <div class="action">
                                                      <ul class="list-unstyled">
                                                          <li class="add-cart-button btn-group">
                                                              <button class="btn btn-primary icon" data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"></i> </button>
                                                              <button class="btn btn-primar y cart-btn" type="button">Add to cart</button>
                                                          </li>
                                                          <li class="lnk wishlist"> <a class="add-to-cart" href="detail.html" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                                                          <li class="lnk"> <a class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal"></i> </a> </li>
                                                      </ul>
